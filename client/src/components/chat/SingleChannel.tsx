...
function SingleChannel() {
  ...
  return (
    <div
      ...
      } duration-300  ease-in-out transition-all     border-r-2 border-white  h-screen text-textColor overflow-auto flex flex-col justify-between absolute z-50 lg:relative bg-bgColor `}
    >
      <div>
